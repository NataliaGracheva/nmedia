    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                liked = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_LIKES)),
                shared = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_SHARES)),
                viewed = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_VIEWS)),
